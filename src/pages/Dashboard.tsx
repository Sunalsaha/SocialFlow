...
const Dashboard = () => {
  ...
  const totalMetrics = mockPlatforms.reduce((acc, platform) => ({
  ...
  const avgEngagementRate = (totalMetrics.engagementRate / mockPlatforms.length).toFixed(1);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
      {/* Header */}
      <motion.header 
        className="bg-slate-800/50 backdrop-blur-sm border-b border-slate-700 p-6"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {mockPlatforms.map((platform, index) => (
              <motion.div
                ...
                className="bg-slate-700/50 p-6 rounded-lg border border-slate-600 hover:border-blue-500/50 transition-all"
              >
